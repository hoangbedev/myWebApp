...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 26, 2022 lúc 06:28 PM
...
--
-- Cơ sở dữ liệu: `cq_quanlybanhang1`
--
...
--
-- Cấu trúc bảng cho bảng `list_of_values`
--

CREATE TABLE `list_of_values` (
  `id_list` int(11) NOT NULL,
  `id_element` int(11) NOT NULL,
  `name_list` varchar(50) CHARACTER SET utf8 NOT NULL,
  `name_element` varchar(50) CHARACTER SET utf8 NOT NULL,
  `description` varchar(200) CHARACTER SET utf8 DEFAULT NULL,
  `create_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Đang đổ dữ liệu cho bảng `list_of_values`
--
...
--
-- Cấu trúc đóng vai cho view `month_chart`
...
--
-- Cấu trúc đóng vai cho view `orders_in_month`
-- (See below for the actual view)
--
...
--
-- Cấu trúc đóng vai cho view `orders_in_year`
-- (See below for the actual view)
--
...
(3, 'Áo Hoodie HX044 (Đỏ - S)', 'S', 'Đỏ', 8, 3, 380000, '/ckfinder/userfiles/images/%C3%81o%20Hoodie/%C3%81o%20Hoodie%20HX044/HXR044.jpg'),
...
(19, 'Áo Hoodie HX129 (Đen - S)', 'S', 'Đen', 9, 10, 300000, '/ckfinder/userfiles/images/%C3%81o%20Hoodie/%C3%81o%20Hoodie%20HX129/HX129D.jpg'),
...
(1, 'admin', 'admin', NULL, 1, '$2y$10$kS6.gqY3j3DgtCedMbrfuOnTiqaYyKDU3/U9ihisfvzmuukKQGwuK', NULL, NULL, '2022-06-21 06:26:09', '2022-06-21 06:26:10'),
(2, 'caoquyen', 'Cao Quyền', NULL, 2, '$2y$10$lppwU0jCZaud.qG5kkzxk.z/62regxvXaiwktcETYnR1lq492LoEO', NULL, NULL, NULL, NULL),
...
(5, NULL, 'Nguyễn Văn Long', 'nguyenvanlong@gmail.com', 3, NULL, '0123456789', 'Số 3, Cầu Giấy, Hà Nội', '2022-06-21 17:04:33', '2022-06-21 17:04:33'),
(6, NULL, 'Trần Lê Minh', 'tranleminh@gmail.com', 3, NULL, '0326447525', '08 ngõ 15 Nguyễn Khang, Cầu Giấy, Hà Nội', '2022-06-21 17:06:52', '2022-06-21 17:06:52'),
(8, NULL, 'Nguyễn Văn Long', 'nguyenvanlong@gmail.com', 3, NULL, '0123456789', 'Số 3, Cầu Giấy, Hà Nội', '2022-06-21 17:14:23', '2022-06-21 17:14:23'),
(9, NULL, 'Phạm Thái Bảo', 'phamthaibao@gmail.com', 3, NULL, '0123456777', 'Số 3, Cầu Giấy, Hà Nội', '2022-06-21 19:13:16', '2022-06-21 19:13:16'),
(10, NULL, 'Nguyễn Văn Binh', 'nguyenvanbinh@gmail.com', 3, NULL, '0123456666', 'Số 3, Cầu Giấy, Hà Nội', '2022-06-21 19:18:33', '2022-06-21 19:18:33'),
(11, NULL, 'Phạm Minh Vũ', 'phamminhvu@gmail.com', 3, NULL, '0123442135', 'Thanh Xuân, Hà Nội', '2022-06-24 11:15:04', '2022-06-24 11:15:04'),
(12, NULL, 'Minh Nguyen', 'caoquyennc1@gmail.com', 3, NULL, '0386510451', 'ha noi', '2022-06-24 15:47:29', '2022-06-24 15:47:29'),
(13, NULL, 'Nguyễn Văn An', 'nguyenvanan@gmail.com', 3, NULL, '0123456777', 'Hà Đông, Hà Nôi', '2022-06-24 17:47:17', '2022-06-24 17:47:17');

-- --------------------------------------------------------

--
-- Cấu trúc đóng vai cho view `year_chart`
-- (See below for the actual view)
--
...
--
-- Cấu trúc đóng vai cho view `year_chart_import`
-- (See below for the actual view)
--
...
--
-- Cấu trúc cho view `orders_in_month`
--
...
--
-- Cấu trúc cho view `orders_in_year`
--
...
--
-- Cấu trúc cho view `year_chart_import`
--
...
--
-- Chỉ mục cho bảng `list_of_values`
--
...
--
-- Các ràng buộc cho bảng `product_models`
--
ALTER TABLE `product_models`
